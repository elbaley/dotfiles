...
-- maximize tmux pane (using windex plugin)
maps.n["<leader>z"] = { "<cmd>lua require('windex').toggle_maximize()<cr>", desc = "Save" }
...
--- Astro Nvim default buffer switch 
-- maps.n["]b"] =
...
-- maps.n["<leader>hx"] = { function() require("harpoon.mark").add_file() end, desc = "Mark file"}
maps.n["<leader>hx"] = { function() require("harpoon.mark").toggle_file() end, desc = "Mark/Unmark file"}
maps.n["<leader>hn"] = { function() require("harpoon.ui").nav_next() end, desc = "Next harpoon mark"}
maps.n["<leader>hp"] = { function() require("harpoon.ui").nav_prev() end, desc = "Previous harpoon mark"}
maps.n["<leader>hm"] =  { "<cmd>Telescope harpoon marks<cr>", desc = "Show all harpoon marks" }
maps.n["<leader>1"] = { function() require("harpoon.ui").nav_file(1) end, desc = "Goto mark 1"}
maps.n["<leader>2"] = { function() require("harpoon.ui").nav_file(2) end, desc = "Goto mark 2"}
maps.n["<leader>3"] = { function() require("harpoon.ui").nav_file(3) end, desc = "Goto mark 3"}
maps.n["<leader>4"] = { function() require("harpoon.ui").nav_file(4) end, desc = "Goto mark 4"}
maps.n["<leader>5"] = { function() require("harpoon.ui").nav_file(4) end, desc = "Goto mark 5"}



-- Trouble Toggle by <leader>XX
maps.n["<leader>xx"] =  { "<cmd>TroubleToggle <cr>", desc = "Trouble Toggle" }
...
-- copilot
maps.i["<C-J>"] = { "copilot#Accept('<CR>')", desc = "Accept copilot" }


-- Others
-- Ctrl U/D impreved scrolling
