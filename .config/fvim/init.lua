...
-- Bufferline Keypmaps (SHIFT+H SHIFT+L to move)
...
--
--
-- FIX: disabled this 2 line to map the <leader>e to Neotree explorer and <leader>q to quit
...
require('lazy').setup {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- INFO: DISABLED telescope lsp definition for LSP SAGA
          -- map('gd', require('telescope.builtin').lsp_definitions, '[G]oto [D]efinition')

          -- INFO: DISABLED telescope lsp references for LSP SAGA
          ...
          --  INFO: disabled for using LSP Saga hover
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          -- TODO: changed it to "Enter" key for confirming for now but might chate it later!
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      --INFO: disabled statusline for using HEIRLINE
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      require('nvim-treesitter.configs').setup {
        ensure_installed = { 'bash', 'c', 'html', 'lua', 'markdown', 'vim', 'vimdoc', 'astro', 'markdown', 'markdown_inline' },
