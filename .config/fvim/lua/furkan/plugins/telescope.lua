return { -- Fuzzy Finder (files, lsp, etc)
  ...
  config = function()
    ...
    --
    -- i18n keymaps
    vim.keymap.set('n', '<leader>te', ':I18nEditTranslation<CR>', { desc = '[T]Translation [E]dit' })
    vim.keymap.set('n', '<leader>t1', ':I18nSetLang tr<CR>', { desc = 'Translation Language: TR' })
    vim.keymap.set('n', '<leader>t2', ':I18nSetLang en<CR>', { desc = 'Translation Language: EN' })
